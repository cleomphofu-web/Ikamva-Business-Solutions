...
- `backend/AGENTS.md` — server API, services, providers, workers, and runtime composition.
- `backend/repositories/AGENTS.md` — tenant-scoped persistence and repository contracts.
- `backend/workers/AGENTS.md` — queue processing, task transitions, and worker lifecycle.
- `src/AGENTS.md` — browser application, presentation, routing, and API-client boundaries.
- `src/pages/client/AGENTS.md` — client Mission Control and lifecycle screens.
- `src/pages/admin/AGENTS.md` — administrative workflows and approval surfaces.
- `src/components/AGENTS.md` — reusable presentation components and UI primitives.
- `supabase/AGENTS.md` — migrations, database policy, and schema history.
- `plugins/AGENTS.md` — external integration adapters and plugin boundaries.
- `docs/AGENTS.md` — architecture records, operational documentation, and roadmap.
