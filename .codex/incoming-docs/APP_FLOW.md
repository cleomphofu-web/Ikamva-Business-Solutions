...
| /signup | Sign up | No |
| /signin | Sign in | No |
| /verify-email | Email confirmation | No |
| /apply | Application form | Yes (unregistered) |
| /application-pending | Waiting screen | Yes |
| /setup | Employee setup (10 steps) | Yes (client) |
| /dashboard | Main dashboard | Yes (client) |
| /dashboard/mission-control | Chat + approvals + logs | Yes (client) |
| /dashboard/billing | Plan and usage | Yes (client) |
| /dashboard/settings | Employee settings | Yes (client) |
| /admin | Admin dashboard | Yes (admin) |
| /admin/applications | Application review | Yes (admin) |
| /admin/subscribers | Client list | Yes (admin) |
| /admin/tasks | Task monitor | Yes (admin) |
