...
### Color tokens
```css
--color-base:        #0f2832   /* darkest background — deep ocean */
--color-surface:     #163340   /* card and panel backgrounds */
--color-surface-2:   #1e4358   /* elevated surfaces, hover states */
--color-border:      #2a5570   /* subtle borders */
--color-border-light:#3a7090   /* visible dividers */
--color-accent:      #4a9abe   /* primary action, links, indicators */
--color-accent-dim:  #2a6a8e   /* hover state on accent */
--color-success:     #3a9a7a   /* connected status, completed states */
--color-warning:     #c8952a   /* pending approvals, amber states */
--color-danger:      #c84a4a   /* errors, disconnected, rejected */
--color-text-primary:#f0f4f6   /* headlines and primary text */
--color-text-secondary:#8ab0c0 /* supporting text, captions */
--color-text-muted:  #5a8090   /* disabled, placeholder */
```
